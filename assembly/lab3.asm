...
CSEG SEGMENT PARA PUBLIC 'CODE'
	...
	MAIN PROC FAR
		...
		program_loop: 
			...
			calculate:
				cmp ax, 1
				jle func_1 ; jump to func_1 if ax <=1
				cmp ax, 20
				jbe func_2 ; jump to func_2 if ax <=20
				jmp func_3 ; otherwise jump to func_3
	...
	func_2_proc proc
		...
		jc func2_overflow
		jo func2_overflow
		div x ; al = ax / x (54 + x^2)/(1+x) dx - reminder of the division 
